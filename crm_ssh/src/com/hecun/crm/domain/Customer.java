...
public class Customer {
	...
	//引用关联的数据字典对象。因为，这三项都是Customer中的外键，引用BaseDict，所以其类型就是BaseDict
	private BaseDict cust_source; //客户来源 希望在表单提交时,提交的键名应该是:cust_source.dict_id.也就是说,在option中的name属性值是这样的.
